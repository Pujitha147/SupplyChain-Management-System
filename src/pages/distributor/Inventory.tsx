...
import { ArrowLeft, Package, AlertTriangle, Calendar, TrendingUp, Download } from 'lucide-react';
...
export default function DistributorInventory() {
  ...
  const fetchInventory = async () => {
    ...
    if (error) {
      ...
      const lowStockCount = data?.filter(item => item.current_quantity < 10).length || 0;
            ...
            <Card>
              <CardContent className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Your inventory is empty. Received shipments will appear here.
                </p>
              </CardContent>
            </Card>
          ) : (
